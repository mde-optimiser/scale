...
import uk.ac.kcl.inf.mdeoptimiser.languages.ide.contentassist.antlr.internal.InternalMeerkatParser;
import uk.ac.kcl.inf.mdeoptimiser.languages.services.MeerkatGrammarAccess;

public class MeerkatParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(MeerkatGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MeerkatGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getProblemConfigurationAccess().getGroup(), "rule__ProblemConfiguration__Group__0");
			builder.put(grammarAccess.getModelAccess().getGroup(), "rule__Model__Group__0");
			builder.put(grammarAccess.getAnalysisConfigurationAccess().getGroup(), "rule__AnalysisConfiguration__Group__0");
			builder.put(grammarAccess.getSummaryAccess().getGroup(), "rule__Summary__Group__0");
			...
			builder.put(grammarAccess.getBatchesAccess().getGroup(), "rule__Batches__Group__0");
			builder.put(grammarAccess.getTerminationConditionAccess().getGroup(), "rule__TerminationCondition__Group__0");
			builder.put(grammarAccess.getToolAccess().getGroup(), "rule__Tool__Group__0");
			builder.put(grammarAccess.getToolConfigurationAccess().getGroup(), "rule__ToolConfiguration__Group__0");
			builder.put(grammarAccess.getReferenceSetAccess().getGroup(), "rule__ReferenceSet__Group__0");
			...
			builder.put(grammarAccess.getAnalyserAccess().getProblemsAssignment(), "rule__Analyser__ProblemsAssignment");
			builder.put(grammarAccess.getProblemAccess().getNameAssignment_2(), "rule__Problem__NameAssignment_2");
			builder.put(grammarAccess.getProblemAccess().getConfigurationAssignment_4(), "rule__Problem__ConfigurationAssignment_4");
			builder.put(grammarAccess.getProblemAccess().getModelsAssignment_5(), "rule__Problem__ModelsAssignment_5");
			builder.put(grammarAccess.getProblemAccess().getAnalysisAssignment_6(), "rule__Problem__AnalysisAssignment_6");
			builder.put(grammarAccess.getProblemConfigurationAccess().getNameAssignment_2(), "rule__ProblemConfiguration__NameAssignment_2");
			builder.put(grammarAccess.getProblemConfigurationAccess().getObjectiveAssignment_4(), "rule__ProblemConfiguration__ObjectiveAssignment_4");
			builder.put(grammarAccess.getProblemConfigurationAccess().getConstraintAssignment_5(), "rule__ProblemConfiguration__ConstraintAssignment_5");
			builder.put(grammarAccess.getProblemConfigurationAccess().getBatchesAssignment_6(), "rule__ProblemConfiguration__BatchesAssignment_6");
			builder.put(grammarAccess.getProblemConfigurationAccess().getTerminationConditionAssignment_7(), "rule__ProblemConfiguration__TerminationConditionAssignment_7");
			builder.put(grammarAccess.getModelAccess().getNameAssignment_2(), "rule__Model__NameAssignment_2");
			builder.put(grammarAccess.getModelAccess().getToolsAssignment_4(), "rule__Model__ToolsAssignment_4");
			builder.put(grammarAccess.getAnalysisConfigurationAccess().getReferenceSetAssignment_2(), "rule__AnalysisConfiguration__ReferenceSetAssignment_2");
			builder.put(grammarAccess.getAnalysisConfigurationAccess().getSummaryAssignment_3(), "rule__AnalysisConfiguration__SummaryAssignment_3");
			builder.put(grammarAccess.getSummaryAccess().getParametersAssignment_2(), "rule__Summary__ParametersAssignment_2");
			builder.put(grammarAccess.getObjectiveAccess().getNameAssignment_2(), "rule__Objective__NameAssignment_2");
			builder.put(grammarAccess.getConstraintAccess().getNameAssignment_2(), "rule__Constraint__NameAssignment_2");
			builder.put(grammarAccess.getBatchesAccess().getNumberAssignment_2(), "rule__Batches__NumberAssignment_2");
			builder.put(grammarAccess.getTerminationConditionAccess().getParametersAssignment_3(), "rule__TerminationCondition__ParametersAssignment_3");
			builder.put(grammarAccess.getToolAccess().getNameAssignment_1(), "rule__Tool__NameAssignment_1");
			builder.put(grammarAccess.getToolAccess().getConfigurationsAssignment_3(), "rule__Tool__ConfigurationsAssignment_3");
			builder.put(grammarAccess.getToolConfigurationAccess().getNameAssignment_1(), "rule__ToolConfiguration__NameAssignment_1");
			builder.put(grammarAccess.getToolConfigurationAccess().getParametersAssignment_3(), "rule__ToolConfiguration__ParametersAssignment_3");
			builder.put(grammarAccess.getReferenceSetAccess().getLocationAssignment_3(), "rule__ReferenceSet__LocationAssignment_3");
	...
	@Override
	protected InternalMeerkatParser createParser() {
		InternalMeerkatParser result = new InternalMeerkatParser(null);
