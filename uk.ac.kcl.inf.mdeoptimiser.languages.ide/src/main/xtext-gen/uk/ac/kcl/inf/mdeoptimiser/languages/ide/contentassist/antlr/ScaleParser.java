...
import uk.ac.kcl.inf.mdeoptimiser.languages.ide.contentassist.antlr.internal.InternalScaleParser;
import uk.ac.kcl.inf.mdeoptimiser.languages.services.ScaleGrammarAccess;

public class ScaleParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(ScaleGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ScaleGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getParameterValueAccess().getAlternatives(), "rule__ParameterValue__Alternatives");
			builder.put(grammarAccess.getParameterValueAccess().getParamsAlternatives_3_2_0_0(), "rule__ParameterValue__ParamsAlternatives_3_2_0_0");
			builder.put(grammarAccess.getParameterValueAccess().getParamsAlternatives_3_2_1_1_0(), "rule__ParameterValue__ParamsAlternatives_3_2_1_1_0");
			...
			builder.put(grammarAccess.getInfrastructureAccess().getGroup_9(), "rule__Infrastructure__Group_9__0");
			...
			builder.put(grammarAccess.getParameterValueAccess().getGroup_3_2(), "rule__ParameterValue__Group_3_2__0");
			builder.put(grammarAccess.getParameterValueAccess().getGroup_3_2_1(), "rule__ParameterValue__Group_3_2_1__0");
			...
			builder.put(grammarAccess.getScaleAccess().getInfrastructureAssignment_0(), "rule__Scale__InfrastructureAssignment_0");
			builder.put(grammarAccess.getScaleAccess().getExperimentsAssignment_1(), "rule__Scale__ExperimentsAssignment_1");
			builder.put(grammarAccess.getInfrastructureAccess().getNameAssignment_1(), "rule__Infrastructure__NameAssignment_1");
			builder.put(grammarAccess.getInfrastructureAccess().getTypeAssignment_4(), "rule__Infrastructure__TypeAssignment_4");
			builder.put(grammarAccess.getInfrastructureAccess().getAccountAssignment_6(), "rule__Infrastructure__AccountAssignment_6");
			builder.put(grammarAccess.getInfrastructureAccess().getEnvironmentAssignment_8(), "rule__Infrastructure__EnvironmentAssignment_8");
			builder.put(grammarAccess.getInfrastructureAccess().getParametersAssignment_9_2(), "rule__Infrastructure__ParametersAssignment_9_2");
			builder.put(grammarAccess.getExperimentAccess().getNameAssignment_1(), "rule__Experiment__NameAssignment_1");
			builder.put(grammarAccess.getExperimentAccess().getParametersAssignment_3_2(), "rule__Experiment__ParametersAssignment_3_2");
			builder.put(grammarAccess.getExperimentAccess().getModelsAssignment_4(), "rule__Experiment__ModelsAssignment_4");
			builder.put(grammarAccess.getModelAccess().getNameAssignment_1(), "rule__Model__NameAssignment_1");
			builder.put(grammarAccess.getModelAccess().getTasksAssignment_3(), "rule__Model__TasksAssignment_3");
			builder.put(grammarAccess.getTaskAccess().getNameAssignment_1(), "rule__Task__NameAssignment_1");
			builder.put(grammarAccess.getTaskAccess().getRunAssignment_3(), "rule__Task__RunAssignment_3");
			builder.put(grammarAccess.getTaskAccess().getDependenciesAssignment_4(), "rule__Task__DependenciesAssignment_4");
			builder.put(grammarAccess.getRunConfigurationAccess().getCommandAssignment_1(), "rule__RunConfiguration__CommandAssignment_1");
			...
			builder.put(grammarAccess.getParameterValueAccess().getPathAssignment_0(), "rule__ParameterValue__PathAssignment_0");
			builder.put(grammarAccess.getParameterValueAccess().getNumericAssignment_1(), "rule__ParameterValue__NumericAssignment_1");
			builder.put(grammarAccess.getParameterValueAccess().getFunctionalAssignment_2(), "rule__ParameterValue__FunctionalAssignment_2");
			builder.put(grammarAccess.getParameterValueAccess().getParametricAssignment_3_0(), "rule__ParameterValue__ParametricAssignment_3_0");
			builder.put(grammarAccess.getParameterValueAccess().getParamsAssignment_3_2_0(), "rule__ParameterValue__ParamsAssignment_3_2_0");
			builder.put(grammarAccess.getParameterValueAccess().getParamsAssignment_3_2_1_1(), "rule__ParameterValue__ParamsAssignment_3_2_1_1");
	...
	@Override
	protected InternalScaleParser createParser() {
		InternalScaleParser result = new InternalScaleParser(null);
