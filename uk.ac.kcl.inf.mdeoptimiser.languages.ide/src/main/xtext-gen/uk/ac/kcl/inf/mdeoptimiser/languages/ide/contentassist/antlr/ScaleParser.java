...
public class ScaleParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ScaleGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getScaleAccess().getTasksAssignment_1(), "rule__Scale__TasksAssignment_1");
			...
			builder.put(grammarAccess.getRunConfigurationAccess().getNameAssignment_1(), "rule__RunConfiguration__NameAssignment_1");
