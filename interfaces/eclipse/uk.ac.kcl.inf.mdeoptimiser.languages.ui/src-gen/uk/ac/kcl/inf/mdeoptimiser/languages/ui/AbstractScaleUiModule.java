...
import uk.ac.kcl.inf.mdeoptimiser.languages.ide.contentassist.antlr.PartialScaleContentAssistParser;
import uk.ac.kcl.inf.mdeoptimiser.languages.ide.contentassist.antlr.ScaleParser;
import uk.ac.kcl.inf.mdeoptimiser.languages.ide.contentassist.antlr.internal.InternalScaleLexer;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.contentassist.ScaleProposalProvider;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.editor.ScaleEditor;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.labeling.ScaleDescriptionLabelProvider;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.labeling.ScaleLabelProvider;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.outline.ScaleOutlineTreeProvider;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.quickfix.ScaleQuickfixProvider;

/**
 * Manual modifications go to {@link ScaleUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractScaleUiModule extends DefaultXbaseUiModule {

	public AbstractScaleUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(uk.ac.kcl.inf.mdeoptimiser.languages.parser.antlr.internal.InternalScaleLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return ScaleParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalScaleLexer.class).toProvider(LexerProvider.create(InternalScaleLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return ScaleLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(ScaleDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return ScaleOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return ScaleQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return ScaleProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialScaleContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Scale Compare");
	}
