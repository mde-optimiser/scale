...
import uk.ac.kcl.inf.mdeoptimiser.languages.ide.contentassist.antlr.MeerkatParser;
import uk.ac.kcl.inf.mdeoptimiser.languages.ide.contentassist.antlr.PartialMeerkatContentAssistParser;
import uk.ac.kcl.inf.mdeoptimiser.languages.ide.contentassist.antlr.internal.InternalMeerkatLexer;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.contentassist.MeerkatProposalProvider;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.editor.MeerkatEditor;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.labeling.MeerkatDescriptionLabelProvider;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.labeling.MeerkatLabelProvider;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.outline.MeerkatOutlineTreeProvider;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.quickfix.MeerkatQuickfixProvider;

/**
 * Manual modifications go to {@link MeerkatUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractMeerkatUiModule extends DefaultXbaseUiModule {

	public AbstractMeerkatUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(uk.ac.kcl.inf.mdeoptimiser.languages.parser.antlr.internal.InternalMeerkatLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return MeerkatParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalMeerkatLexer.class).toProvider(LexerProvider.create(InternalMeerkatLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return MeerkatLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(MeerkatDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return MeerkatOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return MeerkatQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return MeerkatProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialMeerkatContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Meerkat Compare");
	}
