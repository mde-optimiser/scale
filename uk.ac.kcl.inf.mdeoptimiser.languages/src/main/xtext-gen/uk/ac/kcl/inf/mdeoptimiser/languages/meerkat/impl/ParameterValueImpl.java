 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.mdeoptimiser.languages.meerkat.impl.ParameterValueImpl#getNumeric <em>Numeric</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.mdeoptimiser.languages.meerkat.impl.ParameterValueImpl#getFunctional <em>Functional</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.mdeoptimiser.languages.meerkat.impl.ParameterValueImpl#getParametric <em>Parametric</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.mdeoptimiser.languages.meerkat.impl.ParameterValueImpl#getParams <em>Params</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterValueImpl extends MinimalEObjectImpl.Container implements ParameterValue
{
  ...
  {
    return MeerkatPackage.Literals.PARAMETER_VALUE;
  }
  ...
  public void setNumeric(String newNumeric)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MeerkatPackage.PARAMETER_VALUE__NUMERIC, oldNumeric, numeric));
  }
  ...
  public void setFunctional(String newFunctional)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MeerkatPackage.PARAMETER_VALUE__FUNCTIONAL, oldFunctional, functional));
  }
  ...
  public void setParametric(String newParametric)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MeerkatPackage.PARAMETER_VALUE__PARAMETRIC, oldParametric, parametric));
  }
  ...
  public EList<XExpression> getParams()
  {
    if (params == null)
    {
      params = new EObjectContainmentEList<XExpression>(XExpression.class, this, MeerkatPackage.PARAMETER_VALUE__PARAMS);
    }
    return params;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MeerkatPackage.PARAMETER_VALUE__PARAMS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MeerkatPackage.PARAMETER_VALUE__NUMERIC:
        return getNumeric();
      case MeerkatPackage.PARAMETER_VALUE__FUNCTIONAL:
        return getFunctional();
      case MeerkatPackage.PARAMETER_VALUE__PARAMETRIC:
