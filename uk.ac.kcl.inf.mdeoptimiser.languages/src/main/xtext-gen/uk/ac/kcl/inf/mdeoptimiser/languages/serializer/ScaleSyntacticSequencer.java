...
public class ScaleSyntacticSequencer extends AbstractSyntacticSequencer {

	protected ScaleGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (ScaleGrammarAccess) access;
