 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.mdeoptimiser.languages.scale.impl.ParameterValueImpl#getPath <em>Path</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.mdeoptimiser.languages.scale.impl.ParameterValueImpl#getNumeric <em>Numeric</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.mdeoptimiser.languages.scale.impl.ParameterValueImpl#getFunctional <em>Functional</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.mdeoptimiser.languages.scale.impl.ParameterValueImpl#getParametric <em>Parametric</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.mdeoptimiser.languages.scale.impl.ParameterValueImpl#getParams <em>Params</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterValueImpl extends MinimalEObjectImpl.Container implements ParameterValue
{
  ...
  {
    return ScalePackage.Literals.PARAMETER_VALUE;
  }
  ...
  public void setPath(String newPath)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalePackage.PARAMETER_VALUE__PATH, oldPath, path));
  }
  ...
  public void setNumeric(String newNumeric)
  {
    ...
    numeric = newNumeric;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalePackage.PARAMETER_VALUE__NUMERIC, oldNumeric, numeric));
  }
  ...
  public void setFunctional(String newFunctional)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalePackage.PARAMETER_VALUE__FUNCTIONAL, oldFunctional, functional));
  }
  ...
  public void setParametric(String newParametric)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalePackage.PARAMETER_VALUE__PARAMETRIC, oldParametric, parametric));
  }
  ...
  public EList<XExpression> getParams()
  {
    if (params == null)
    {
      params = new EObjectContainmentEList<XExpression>(XExpression.class, this, ScalePackage.PARAMETER_VALUE__PARAMS);
    }
    return params;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ScalePackage.PARAMETER_VALUE__PARAMS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ScalePackage.PARAMETER_VALUE__PATH:
        return getPath();
      case ScalePackage.PARAMETER_VALUE__NUMERIC:
        return getNumeric();
      case ScalePackage.PARAMETER_VALUE__FUNCTIONAL:
        return getFunctional();
      case ScalePackage.PARAMETER_VALUE__PARAMETRIC:
