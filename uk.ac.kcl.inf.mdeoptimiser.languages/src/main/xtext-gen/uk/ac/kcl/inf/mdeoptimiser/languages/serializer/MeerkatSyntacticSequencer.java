...
public class MeerkatSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MeerkatGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (MeerkatGrammarAccess) access;
