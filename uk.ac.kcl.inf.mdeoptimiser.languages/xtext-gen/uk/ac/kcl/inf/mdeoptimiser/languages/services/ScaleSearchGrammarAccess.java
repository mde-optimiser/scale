...
@Singleton
public class ScaleSearchGrammarAccess extends AbstractGrammarElementFinder {
	
	public class ScaleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "uk.ac.kcl.inf.mdeoptimiser.languages.ScaleSearch.Scale");
	...
	public class InfrastructureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "uk.ac.kcl.inf.mdeoptimiser.languages.ScaleSearch.Infrastructure");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//'infrastructure' name=ID '{' 'type' type=STRING 'account' account=STRING '}'
		public Group getGroup() { return cGroup; }
	...
	public class TaskElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "uk.ac.kcl.inf.mdeoptimiser.languages.ScaleSearch.Task");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//'task' name=ID '{' run=RunConfiguration dependencies=Dependency '}'
		public Group getGroup() { return cGroup; }
	...
	public class RunConfigurationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "uk.ac.kcl.inf.mdeoptimiser.languages.ScaleSearch.RunConfiguration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DependencyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "uk.ac.kcl.inf.mdeoptimiser.languages.ScaleSearch.Dependency");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	@Inject
	public ScaleSearchGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("uk.ac.kcl.inf.mdeoptimiser.languages.ScaleSearch".equals(grammar.getName())) {
				return grammar;
			}
